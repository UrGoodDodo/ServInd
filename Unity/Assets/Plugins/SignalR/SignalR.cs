...
public class SignalR
{
    ...
    #region Invoke Editor
        ...
        #region InvokeWithResult Editor
    /// <summary>
    /// Вызывает метод хаба, возвращающий результат типа T.
    /// </summary>
    public Task<T> InvokeWithResult<T>(string methodName, params object[] args)
    {
        // Вызовет connection.InvokeAsync<T>(methodName, args...)
        return connection.InvokeAsync<T>(methodName, args);
    }
    #endregion
